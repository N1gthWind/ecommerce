                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title mt-4">Add Category</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="category-meta-keywords" class="form-label">Meta Keywords</label>
                                        <input v-model="form.meta_keywords" type="text" class="form-control"
                                            id="category-meta-keywords" placeholder="Enter keywords">
                                    ...
                                    <div>
                                        <label for="category-meta-description" class="form-label">Meta Description
                                        </label>
...
const submitCategory = () => {
    Inertia.post(route('admin.categories.store'), form);
}
